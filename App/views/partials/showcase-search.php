...
<section class="showcase relative bg-cover bg-center bg-no-repeat h-72 flex items-center">
  ...
  <div class="container mx-auto text-center z-10">
    ...
    <form method="GET" action="/listings/search" class="mb-4 block mx-5 md:mx-auto">
      <input type="text" name="keywords" placeholder="关键词" class="w-full md:w-auto mb-2 px-4 py-2 focus:outline-none" />
      <input type="text" name="location" placeholder="位置" class="w-full md:w-auto mb-2 px-4 py-2 focus:outline-none" />
